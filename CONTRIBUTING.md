...
Fork the project [on GitHub](https://github.com/geut/jsdast) and check out your copy locally.

```bash
$ git clone git@github.com:username/jsdast.git
$ cd jsdast
$ npm install
$ git remote add upstream git://github.com/geut/jsdast.git
```
